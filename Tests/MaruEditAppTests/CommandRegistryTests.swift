...
final class CommandRegistryTests: XCTestCase {
    ...
    func testAllAppCommandsAreRegisteredAndUniquelyIdentified() async {
        ...
        let ids: [CommandID] = [
            ...
            .viewWebBrowseMode,
            .editDeleteWordAll, .editCopyWord, .editCutWord, .editCopyLine,
            .editCutLine, .editCutToLineEnd, .editClearUndoBuffer,
            .viewToggleFloatingToolbar,
            ...
            .searchGrepReplace,
            .searchClearHistory, .viewToggleSidebar, .viewToggleToolbar, .viewToggleTabMode,
            .viewToggleWrap, .viewToggleTableMode,
            ...
            .editTitlecase, .editCompleteWord, .editCut, .editCopy, .editPaste,
            .insertDateTime, .insertNewline,
