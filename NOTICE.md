...
or endorsed by the developers of Hidemaru Editor. See `ROADMAP.md` sections
...
- added `NOTICE.md`, `UPSTREAM.md`, and `ROADMAP.md` to define MaruEdit's
  own product direction as a keyboard-first, Hidemaru-workflow-inspired
...
Hidemaru Editor source code, binaries, icons, or other protected resources.
See `ROADMAP.md` section 3.1 for what is and is not permitted when studying
Hidemaru's publicly observable behavior.
