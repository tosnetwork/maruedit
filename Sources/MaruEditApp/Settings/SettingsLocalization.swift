...
enum SettingsLocalization {
    ...
    static func text(_ key: String, language: SettingsLanguage = language) -> String {
        let values: [String: [SettingsLanguage: String]] = [
            ...
            "wrapMode": [.english: "Line wrapping", .japanese: "折り返し方式", .simplifiedChinese: "折行方式"],
            "wrapColumn": [.english: "Fixed wrap column", .japanese: "固定折り返し桁", .simplifiedChinese: "固定折行列"],
            "wrapNone": [.english: "No wrapping", .japanese: "折り返さない", .simplifiedChinese: "不折行"],
            "wrapWindow": [.english: "Window width", .japanese: "ウィンドウ幅", .simplifiedChinese: "窗口宽度"],
            "wrapFixed": [.english: "Fixed columns", .japanese: "固定幅", .simplifiedChinese: "固定列数"],
            "wrapMaximum": [.english: "Maximum width", .japanese: "最大幅", .simplifiedChinese: "最大宽度"],
            ...
            "workspace": [.english: "Workspace", .japanese: "ワークスペース", .simplifiedChinese: "工作区"],
            "classicWorkspace": [.english: "Maru Classic", .japanese: "Maru Classic", .simplifiedChinese: "Maru Classic"],
            "modernWorkspace": [.english: "Maru Modern", .japanese: "Maru Modern", .simplifiedChinese: "Maru Modern"],
