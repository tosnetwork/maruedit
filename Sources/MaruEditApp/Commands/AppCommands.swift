...
extension CommandID {
    ...
    static let macroRepeatPlayback = CommandID("macro.repeatPlayback")
    static let macroSaveRecording = CommandID("macro.saveRecording")
    static let macroRun = CommandID("macro.run")
    static let macroReload = CommandID("macro.reload")
    static let macroOpenFolder = CommandID("macro.openFolder")
    static let macroHelp = CommandID("macro.help")
    ...
    static let fileToggleOverwriteProtection = CommandID("file.toggleOverwriteProtection")
    static let fileToggleHistoryRecording = CommandID("file.toggleHistoryRecording")
    ...
    static let searchGrepReplace = CommandID("search.grepReplace")
    ...
    static let searchOutlineAllMatches = CommandID("search.outlineAllMatches")
    static let searchListColorLayers = CommandID("search.listColorLayers")
    static let searchToggleMark = CommandID("search.toggleMark")
    static let searchListMarks = CommandID("search.listMarks")
    static let searchClearAllMarks = CommandID("search.clearAllMarks")
    static let searchClearCurrentMarks = CommandID("search.clearCurrentMarks")
    static let searchNextResult = CommandID("search.nextResult")
    static let searchPreviousResult = CommandID("search.previousResult")
    static let searchNextGrepResult = CommandID("search.nextGrepResult")
    static let searchPreviousGrepResult = CommandID("search.previousGrepResult")
    ...
    static let viewToggleToolbar = CommandID("view.toggleToolbar")
    ...
    static let viewToggleSpellChecking = CommandID("view.toggleSpellChecking")
    static let viewShowCharacterCode = CommandID("view.showCharacterCode")
    static let viewShowCharacterCount = CommandID("view.showCharacterCount")
    static let viewRedraw = CommandID("view.redraw")
    static let viewToggleFullScreen = CommandID("view.toggleFullScreen")
    ...
    static let highlightTemporaryConfigure = CommandID("highlight.temporary.configure")
    static let highlightTemporaryApply = CommandID("highlight.temporary.apply")
    static let highlightTemporaryRemove = CommandID("highlight.temporary.remove")
    static let highlightTemporaryClear = CommandID("highlight.temporary.clear")
    static let highlightTemporarySelect = CommandID("highlight.temporary.select")
    static let highlightTemporaryNext = CommandID("highlight.temporary.next")
    static let highlightTemporaryPrevious = CommandID("highlight.temporary.previous")
    static let highlightNextLine = CommandID("highlight.nextLine")
    static let highlightOutlineAnalysis = CommandID("highlight.outlineAnalysis")
    static let highlightPreviousLine = CommandID("highlight.previousLine")
    static let highlightSelectLineArea = CommandID("highlight.selectLineArea")
...
enum AppCommands {
    static func registerAll(in registry: CommandRegistry) {
        ...
        registry.register(CommandDefinition(id: .macroRepeatPlayback, title: "Repeat Recorded Commands…") { $0.coordinator.repeatMacroRecording() })
        registry.register(CommandDefinition(id: .macroSaveRecording, title: "Save Recording as Macro…") { $0.coordinator.saveMacroRecording() })
        registry.register(CommandDefinition(id: .macroRun, title: "Run Macro…") { $0.coordinator.showMacroMenu() })
        registry.register(CommandDefinition(id: .macroReload, title: "Reload Macros") { $0.coordinator.reloadMacros() })
        registry.register(CommandDefinition(id: .macroOpenFolder, title: "Open Macro Folder") { $0.coordinator.openMacroFolder() })
        registry.register(CommandDefinition(id: .macroHelp, title: "Macro Help") { $0.coordinator.showMacroHelp() })
        ...
        registry.register(CommandDefinition(id: .fileToggleOverwriteProtection, title: "Prohibit Overwrite") { $0.coordinator.toggleOverwriteProtection() })
        registry.register(CommandDefinition(id: .fileToggleHistoryRecording, title: "Suspend History Recording") { $0.coordinator.toggleHistoryRecording() })
        ...
        registry.register(CommandDefinition(id: .searchGrepReplace, title: "Grep Replace…") { $0.coordinator.showGrepReplace() })
        ...
        registry.register(CommandDefinition(id: .searchOutlineAllMatches, title: "Show All Matches in Outline") { $0.coordinator.outlineAllSearchMatches() })
        registry.register(CommandDefinition(id: .searchListColorLayers, title: "Search Color List…") { $0.coordinator.listSearchColorLayers() })
        registry.register(CommandDefinition(id: .searchToggleMark, title: "Mark/Unmark Current Line") { $0.coordinator.toggleMarker(.yellow) })
        registry.register(CommandDefinition(id: .searchListMarks, title: "Mark List…") { $0.coordinator.showMarkerList() })
        registry.register(CommandDefinition(id: .searchClearAllMarks, title: "Clear All Marks") { $0.coordinator.clearAllDocumentMarkers() })
        registry.register(CommandDefinition(id: .searchClearCurrentMarks, title: "Clear Marks in Current File") { $0.coordinator.clearMarkers() })
        registry.register(CommandDefinition(id: .searchNextResult, title: "Next Result") { $0.coordinator.navigateResult(forward: true, grepOnly: false) })
        registry.register(CommandDefinition(id: .searchPreviousResult, title: "Previous Result") { $0.coordinator.navigateResult(forward: false, grepOnly: false) })
        registry.register(CommandDefinition(id: .searchNextGrepResult, title: "Next Grep Result") { $0.coordinator.navigateResult(forward: true, grepOnly: true) })
        registry.register(CommandDefinition(id: .searchPreviousGrepResult, title: "Previous Grep Result") { $0.coordinator.navigateResult(forward: false, grepOnly: true) })
        ...
        registry.register(CommandDefinition(id: .viewToggleToolbar, title: "Toolbar") { $0.coordinator.toggleClassicToolbar() })
        ...
        registry.register(CommandDefinition(id: .viewToggleSpellChecking, title: "Automatic Spell Checking") { $0.coordinator.toggleSpellChecking() })
        registry.register(CommandDefinition(id: .viewShowCharacterCode, title: "Character Code") { $0.coordinator.showCharacterCode() })
        registry.register(CommandDefinition(id: .viewShowCharacterCount, title: "Character Count") { $0.coordinator.showCharacterCount() })
        registry.register(CommandDefinition(id: .viewRedraw, title: "Redraw") { $0.coordinator.redrawEditor() })
        registry.register(CommandDefinition(id: .viewToggleFullScreen, title: "Toggle Full Screen") { $0.coordinator.toggleFullScreen() })
        ...
        registry.register(CommandDefinition(id: .highlightTemporaryConfigure, title: "Temporary Color Marker…") { $0.coordinator.configureTemporaryColorMarker() })
        registry.register(CommandDefinition(id: .highlightTemporaryApply, title: "Apply Temporary Color Marker") { $0.coordinator.applyTemporaryColorMarker() })
        registry.register(CommandDefinition(id: .highlightTemporaryRemove, title: "Remove Temporary Color Marker") { $0.coordinator.removeTemporaryColorMarker() })
        registry.register(CommandDefinition(id: .highlightTemporaryClear, title: "Clear All Temporary Color Markers") { $0.coordinator.clearTemporaryColorMarkers() })
        registry.register(CommandDefinition(id: .highlightTemporarySelect, title: "Select Temporary Color Markers") { $0.coordinator.selectTemporaryColorMarkers() })
        registry.register(CommandDefinition(id: .highlightTemporaryNext, title: "Next Temporary Color Marker") { $0.coordinator.nextTemporaryColorMarker() })
        registry.register(CommandDefinition(id: .highlightTemporaryPrevious, title: "Previous Temporary Color Marker") { $0.coordinator.previousTemporaryColorMarker() })
        registry.register(CommandDefinition(id: .highlightNextLine, title: "Next Highlighted Line") { $0.coordinator.nextHighlightedLine() })
        registry.register(CommandDefinition(id: .highlightOutlineAnalysis, title: "Outline Analysis…") { $0.coordinator.showOutlineAnalysis() })
        registry.register(CommandDefinition(id: .highlightPreviousLine, title: "Previous Highlighted Line") { $0.coordinator.previousHighlightedLine() })
        registry.register(CommandDefinition(id: .highlightSelectLineArea, title: "Select Highlighted Line Area") { $0.coordinator.selectHighlightedLineArea() })
