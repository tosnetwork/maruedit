...
extension CommandID {
    ...
    static let macroToggleRecording = CommandID("macro.toggleRecording")
    ...
    static let toolsOpenFinder = CommandID("tools.openFinder")
    static let toolsConfigureUserMenus = CommandID("tools.configureUserMenus")
    ...
    static let windowTileVertical = CommandID("window.tileVertical")
    static let windowTileHorizontal = CommandID("window.tileHorizontal")
    static let windowCascade = CommandID("window.cascade")
    static let windowTileGrid = CommandID("window.tileGrid")
    static let windowMinimizeAll = CommandID("window.minimizeAll")
    static let windowAlwaysOnTop = CommandID("window.alwaysOnTop")
    static let windowFullScreen = CommandID("window.fullScreen")
    static let windowDetachTab = CommandID("window.detachTab")
    static let windowMinimizeTab = CommandID("window.minimizeTab")
    static let windowShowFilesPane = CommandID("window.showFilesPane")
    static let windowShowOutlinePane = CommandID("window.showOutlinePane")
    static let windowShowDocumentBrowserPane = CommandID("window.showDocumentBrowserPane")
    static let windowShowSharedBrowserPane = CommandID("window.showSharedBrowserPane")
    static let windowToggleBrowserPane = CommandID("window.toggleBrowserPane")
    static let windowFocusBrowserPane = CommandID("window.focusBrowserPane")
    static let windowToggleCrossDocumentScrollLink = CommandID("window.toggleCrossDocumentScrollLink")
    static let windowNextManaged = CommandID("window.nextManaged")
    static let windowPreviousManaged = CommandID("window.previousManaged")
    static let windowNextManagedIncludingMinimized = CommandID("window.nextManagedIncludingMinimized")
    static let windowPreviousManagedIncludingMinimized = CommandID("window.previousManagedIncludingMinimized")
    static let windowPreviousActive = CommandID("window.previousActive")
    static let viewToggleFoldMargin = CommandID("view.toggleFoldMargin")
    static let viewBeginPartialEditing = CommandID("view.beginPartialEditing")
    static let viewEndPartialEditing = CommandID("view.endPartialEditing")
    static let viewWebBrowseMode = CommandID("view.webBrowseMode")
    static let editDeleteWordAll = CommandID("edit.deleteWordAll")
    static let editCut = CommandID("edit.cut")
    static let editCopy = CommandID("edit.copy")
    static let editPaste = CommandID("edit.paste")
    static let editCopyWord = CommandID("edit.copyWord")
    static let editCutWord = CommandID("edit.cutWord")
    static let editCopyLine = CommandID("edit.copyLine")
    static let editCutLine = CommandID("edit.cutLine")
    static let editCutToLineEnd = CommandID("edit.cutToLineEnd")
    static let editClearUndoBuffer = CommandID("edit.clearUndoBuffer")
    static let viewToggleFloatingToolbar = CommandID("view.toggleFloatingToolbar")
    ...
    static let viewToggleTabMode = CommandID("view.toggleTabMode")
    ...
    static let viewToggleCurrentLineHighlight = CommandID("view.toggleCurrentLineHighlight")
...
enum AppCommands {
    static func registerAll(in registry: CommandRegistry) {
        ...
        registry.register(CommandDefinition(id: .macroToggleRecording, title: "Start/Stop Recording") { $0.coordinator.toggleMacroRecording() })
        ...
        registry.register(CommandDefinition(id: .windowTileVertical, title: "Tile Vertically") { $0.coordinator.arrangeWindowsVertically() })
        registry.register(CommandDefinition(id: .windowTileHorizontal, title: "Tile Horizontally") { $0.coordinator.arrangeWindowsHorizontally() })
        registry.register(CommandDefinition(id: .windowCascade, title: "Cascade Windows") { $0.coordinator.cascadeWindows() })
        registry.register(CommandDefinition(id: .windowTileGrid, title: "Tile Windows") { $0.coordinator.arrangeWindowsGrid() })
        registry.register(CommandDefinition(id: .windowMinimizeAll, title: "Minimize All") { $0.coordinator.minimizeAllWindows() })
        registry.register(CommandDefinition(id: .windowAlwaysOnTop, title: "Always on Top") { $0.coordinator.toggleAlwaysOnTop() })
        registry.register(CommandDefinition(id: .windowFullScreen, title: "Full Screen") { $0.coordinator.toggleFullScreen() })
        registry.register(CommandDefinition(id: .windowDetachTab, title: "Detach/Move This Tab") { $0.coordinator.detachCurrentTab() })
        registry.register(CommandDefinition(id: .windowMinimizeTab, title: "Minimize This Tab Window") { $0.coordinator.minimizeCurrentTabWindow() })
        registry.register(CommandDefinition(id: .windowShowFilesPane, title: "File Manager Pane") { $0.coordinator.showFilesPane() })
        registry.register(CommandDefinition(id: .windowShowOutlinePane, title: "Outline Analysis Pane") { $0.coordinator.showOutlinePane() })
        registry.register(CommandDefinition(id: .windowShowDocumentBrowserPane, title: "Document Browser Pane") { $0.coordinator.showDocumentBrowserPane() })
        registry.register(CommandDefinition(id: .windowShowSharedBrowserPane, title: "Browser Pane") { $0.coordinator.showSharedBrowserPane() })
        registry.register(CommandDefinition(id: .windowToggleBrowserPane, title: "Show/Hide Browser Pane") { $0.coordinator.toggleBrowserPane() })
        registry.register(CommandDefinition(id: .windowFocusBrowserPane, title: "Focus Browser Pane") { $0.coordinator.focusBrowserPane() })
        registry.register(CommandDefinition(id: .windowToggleCrossDocumentScrollLink, title: "Scroll Link with Other Windows") { $0.coordinator.toggleCrossDocumentScrollLink() })
        registry.register(CommandDefinition(id: .windowNextManaged, title: "Next MaruEdit Window") { $0.coordinator.activateRelativeWindow(1, includingMinimized: false) })
        registry.register(CommandDefinition(id: .windowPreviousManaged, title: "Previous MaruEdit Window") { $0.coordinator.activateRelativeWindow(-1, includingMinimized: false) })
        registry.register(CommandDefinition(id: .windowNextManagedIncludingMinimized, title: "Next Window Including Minimized") { $0.coordinator.activateRelativeWindow(1, includingMinimized: true) })
        registry.register(CommandDefinition(id: .windowPreviousManagedIncludingMinimized, title: "Previous Window Including Minimized") { $0.coordinator.activateRelativeWindow(-1, includingMinimized: true) })
        registry.register(CommandDefinition(id: .windowPreviousActive, title: "Previously Active Window") { $0.coordinator.activatePreviouslyActiveWindow() })
        registry.register(CommandDefinition(id: .viewToggleFoldMargin, title: "Folding Margin") { $0.coordinator.toggleFoldMargin() })
        registry.register(CommandDefinition(id: .viewBeginPartialEditing, title: "Range Edit In") { $0.coordinator.beginPartialOutlineEditing() })
        registry.register(CommandDefinition(id: .viewEndPartialEditing, title: "Range Edit Out") { $0.coordinator.endPartialOutlineEditing() })
        registry.register(CommandDefinition(id: .viewWebBrowseMode, title: "Web Browse Mode") { $0.coordinator.showDocumentBrowserPane() })
        registry.register(CommandDefinition(id: .editDeleteWordAll, title: "Delete Whole Word") { $0.coordinator.deleteCurrentWord() })
        registry.register(CommandDefinition(id: .editCut, title: "Cut") { $0.coordinator.cut() })
        registry.register(CommandDefinition(id: .editCopy, title: "Copy") { $0.coordinator.copy() })
        registry.register(CommandDefinition(id: .editPaste, title: "Paste") { $0.coordinator.paste() })
        registry.register(CommandDefinition(id: .editCopyWord, title: "Copy Word") { $0.coordinator.copyCurrentWord() })
        registry.register(CommandDefinition(id: .editCutWord, title: "Cut Word") { $0.coordinator.cutCurrentWord() })
        registry.register(CommandDefinition(id: .editCopyLine, title: "Copy Line") { $0.coordinator.copyCurrentLine() })
        registry.register(CommandDefinition(id: .editCutLine, title: "Cut Line") { $0.coordinator.cutCurrentLine() })
        registry.register(CommandDefinition(id: .editCutToLineEnd, title: "Cut after Cursor") { $0.coordinator.cutToLineEnd() })
        registry.register(CommandDefinition(id: .editClearUndoBuffer, title: "Clear Undo Buffer") { $0.coordinator.clearUndoBuffer() })
        registry.register(CommandDefinition(id: .viewToggleFloatingToolbar, title: "Floating Toolbar") { $0.coordinator.toggleFloatingToolbar() })
        ...
        registry.register(CommandDefinition(id: .viewToggleTabMode, title: "Tab Mode") { $0.coordinator.toggleTabMode() })
        ...
        registry.register(CommandDefinition(id: .viewToggleCurrentLineHighlight, title: "Highlight Current Line") { $0.coordinator.toggleCurrentLineHighlight() })
