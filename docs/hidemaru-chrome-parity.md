...
|---|---|---|
| File | File | Reload, properties, rename, View Mode, append save/read, bounded partial open, editable 16-byte hexadecimal binary mode, close-and-open, Save and Close, and Save All and Close are present; missing project/desktop histories |
...
menus. MaruEdit currently registers 146 stable command IDs. Duplicate menu
