...
|---|---|---|
| File | File | Reload, properties, rename, View Mode and append save/read are present; missing partial open, close-and-open, save-and-exit variants, project/desktop histories and binary mode |
...
menus. MaruEdit currently registers 109 stable command IDs. Duplicate menu
