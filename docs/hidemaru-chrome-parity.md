...
| Edit | Edit | Core clipboard/Undo and line editing, bounded clipboard history, quoted copy/paste, and word/line/paragraph selection are present; missing restore deletion and kana/CapsLock correction |
...
menus. MaruEdit currently registers 140 stable command IDs. Duplicate menu
