...
| macOS 14 / Apple Silicon | GitHub Actions `macos-14` | Passed: Release build, 402 tests, audits, app package, and 111-test beta smoke |
| macOS 15 / Apple Silicon | GitHub Actions `macos-15` | Passed: Release build, 402 tests, audits, app package, and 111-test beta smoke |
| macOS 15 / Intel x86_64 | GitHub Actions `macos-15-intel` | Passed: Release build, 402 tests, audits, app package, and 111-test beta smoke |
| macOS 26 / Apple Silicon | Local MacBook Air M2 and GitHub Actions `macos-26` | Passed locally and in the complete CI matrix |
...
Canonical matrix evidence: [GitHub Actions run 30960385965](https://github.com/tosnetwork/maruedit/actions/runs/30960385965), commit `0f9a2ca`.

## Functional coverage

| Area | Automated evidence | Manual evidence / remaining work |
|---|---|---|
| English, Japanese, Simplified Chinese | Localization tables and tests cover all three explicit values | Automated locale selection passed; visible truncation remains a release-candidate visual check |
...
| Accessibility | Explicit labels/roles/values and keyboard-navigation tests | Real VoiceOver spoken-navigation smoke remains required before release |
