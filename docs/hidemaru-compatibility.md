# Hidemaru Workflow Compatibility

MaruEdit is an independent macOS project, not a port endorsed by Hidemaru's
...
| Native Hidemaru macros/plugins | Not supported | No proprietary runtime or binary plugin ABI |
