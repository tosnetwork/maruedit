# Maru Workflow Compatibility

MaruEdit is an independent macOS project, not a port endorsed by Maru's
...
| Native Maru macros/plugins | Not supported | No proprietary runtime or binary plugin ABI |
...
[MaruEdit / Maru Product Gap Analysis](maru-gap-analysis.md).
